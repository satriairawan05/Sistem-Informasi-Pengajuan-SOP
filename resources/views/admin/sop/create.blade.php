                        ...
                        <div class="form-group">
                            <div class="row mb-3">
                                <div class="col-12">
                                    ...
                                    <input type="text"
                                        class="form-control form-control-sm @error('sop_nama')
                                    is-invalidss
                                @enderror"
                                        id="sop_nama" placeholder="Masukan Nama" value="{{ old('sop_nama') }}"
                                        name="sop_nama" required>
                                    @error('sop_nama')
                            ...
                            <div class="row mb-3">
                                <div class="col-12">
                                    ...
                                    is-invalidss
                                @enderror"
                                        id="sop_nomor" placeholder="Masukan Nomor" value="{{ old('sop_nomor') }}"
                                        name="sop_nomor" required>
                                    @error('sop_nomor')
                                        <div class="invalid-feedback">
                                            {{ $message }}
                                        </div>
