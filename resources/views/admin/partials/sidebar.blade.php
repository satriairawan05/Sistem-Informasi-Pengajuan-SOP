<div class="main-sidebar sidebar-style-2">
    <aside id="sidebar-wrapper">
        ...
        <div class="sidebar-brand sidebar-brand-sm">
            <a href="{{ route('home') }}"><img src="{{ asset('assets/img/logoakg.png') }}" alt="{{ env('APP_NAME') }}" class="h-50 w-50"></a>
        </div>
        <ul class="sidebar-menu">
            ...
            <li class="dropdown">
                <a href="#" class="nav-link"><i class="fas fa-building"></i>
            ...
            <li class="dropdown">
                <a href="#" class="nav-link"><i class="fas fa-user-cog"></i>
                    <span>Roles</span></a>
            </li>
        </ul>
    </aside>
